...
local crafters = {
	-- Craftbot 1
	[tostring( obj_craftbot_craftbot1_t )] = {
		needsPower = false,
		slots = 2,
		speed = 1,
		upgrade = tostring( obj_craftbot_craftbot2_t ),
		upgradeCost = 5,
		recipeSets = {
			{ name = "craftbot", locked = false },
            { name = "craftbot2", locked = true }
		},
		subTitle = "#{LEVEL} 1",
		createGuiFunction = sm.gui.createCraftBotGui
	},
	-- Craftbot 2
	[tostring( obj_craftbot_craftbot2_t )] = {
		needsPower = false,
		slots = 4,
		speed = 1,
		upgrade = tostring( obj_craftbot_craftbot3_t ),
		upgradeCost = 5,
		recipeSets = {
			{ name = "craftbot", locked = false },
	...
	-- Craftbot 3
	[tostring( obj_craftbot_craftbot3_t )] = {
		needsPower = false,
		slots = 6,
		speed = 1,
		upgrade = tostring( obj_craftbot_craftbot4_t ),
		upgradeCost = 5,
		recipeSets = {
			{ name = "craftbot", locked = false }
		},
	...
	-- Craftbot 4
	[tostring( obj_craftbot_craftbot4_t )] = {
		needsPower = false,
		slots = 8,
		speed = 1,
		upgrade = tostring( obj_craftbot_craftbot5_t ),
		upgradeCost = 20,
		recipeSets = {
			{ name = "craftbot", locked = false }
		},
	...
	-- Craftbot 5
	[tostring( obj_craftbot_craftbot5_t )] = {
		needsPower = false,
		slots = 8,
		speed = 2,
		recipeSets = {
...
function Crafter.cl_updateRecipeGrid( self )
    ...
    print("self.crafter", self.crafter)
    print("self.crafter.recipeSets", self.crafter.recipeSets)
